...
public class PersonDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnadd.setText("Add dress details");
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        double budget=Double.parseDouble(txt1.getText());
        int noOfDresses=Integer.parseInt(txt2.getText());
        Person p=new Person(budget, noOfDresses);
        
        DressDetails ddf=new DressDetails(p);
        ddf.setVisible(true);
